...
#pruebas para new topics
class NewTopicTests(TestCase):

    def setUp(self):
        self.borad = Board.objects.create(name='Django', description='Django board.')
    ...
    #pruebas para new topics de creacion de topics
    def test_csrf(self):
        url = reverse('new_topic', kwargs={'pk': 1})
        response = self.client.get(url)
